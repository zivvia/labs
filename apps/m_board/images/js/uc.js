	...
	if(action == 'open') {
		...
		if(!$('pmlayer_bg')) {
			...
			$('pmlayer').innerHTML = '<div style="width: 800px; background: #666666; margin: 5px auto; text-align: left;">' +
				...
				'<a href="###" onclick="pmwin(\'close\')"><img style="position: absolute;right: 20px;top: 15px" border="0" src="images/close.gif" title="¹Ø±Õ" /></a>' +
		...
		if(!param) {
			pmframe.location = 'index.php?do=pmwin';
		} else {
			pmframe.location = 'index.php?do=pmwin&' + param;
		}
